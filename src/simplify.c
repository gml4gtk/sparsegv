...
static int replace_insn_pair(struct instruction *out, int op_out, struct instruction *in, int op_in, pseudo_t a, pseudo_t b,
			     pseudo_t c)
{
...
{
	return simplify_add_one_side(insn, &insn->src1, &insn->src2) || simplify_add_one_side(insn, &insn->src2, &insn->src1);
}
...
{
	return simplify_and_one_side(insn, &insn->src1, &insn->src2) || simplify_and_one_side(insn, &insn->src2, &insn->src1);
}
...
{
	return simplify_ior_one_side(insn, &insn->src1, &insn->src2) || simplify_ior_one_side(insn, &insn->src2, &insn->src1);
}
...
{
	return simplify_xor_one_side(insn, &insn->src1, &insn->src2) || simplify_xor_one_side(insn, &insn->src2, &insn->src1);
}
